...
ВАЖНО: Не придумывай ответ от себя. Честно скажи, что в предоставленных документах нет информации для ответа на этот вопрос.`;
      }
      return question;
    }
    ...
    let prompt = `Используй следующую информацию из документов для ответа на вопрос. Если информация в документах не содержит ответа на вопрос, скажи об этом честно.
